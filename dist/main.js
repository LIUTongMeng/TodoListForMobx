...
function reaction$$1(expression, effect, opts) {
    ...
    if (true) {
        ...
        invariant$$1((typeof opts === "undefined" ? "undefined" : _typeof(opts)) === "object", "Third argument of reactions should be an object");
    }
...
var _dec, _desc, _value, _class, _descriptor, _descriptor2, _dec2, _dec3, _desc2, _value2, _class3, _descriptor3, _class5, _class6, _temp2, _class7, _class8, _temp4;
...
var Item = (_dec = _mobx.action.bound, (_class = function () {
    function Item(title) {
...
}), _applyDecoratedDescriptor(_class.prototype, 'toogle', [_dec], Object.getOwnPropertyDescriptor(_class.prototype, 'toogle'), _class.prototype)), _class));
var Store = (_dec2 = _mobx.action.bound, _dec3 = _mobx.action.bound, (_class3 = function () {
    function Store() {
    ...
    return Store;
}(), (_descriptor3 = _applyDecoratedDescriptor(_class3.prototype, 'list', [_mobx.observable], {
    enumerable: true,
    initializer: function initializer() {
        return [];
    }
}), _applyDecoratedDescriptor(_class3.prototype, 'createTodo', [_dec2], Object.getOwnPropertyDescriptor(_class3.prototype, 'createTodo'), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, 'removeItem', [_dec3], Object.getOwnPropertyDescriptor(_class3.prototype, 'removeItem'), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, 'left', [_mobx.computed], Object.getOwnPropertyDescriptor(_class3.prototype, 'left'), _class3.prototype)), _class3));


var store = new Store();

var TodoItem = (0, _mobxReact.observer)(_class5 = (_temp2 = _class6 = function (_Component) {
    ...
    function TodoItem() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TodoItem.__proto__ || Object.getPrototypeOf(TodoItem)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (e) {
            _this.props.item.toogle();
    ...
    _createClass(TodoItem, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _react.Fragment,
                null,
                _react2.default.createElement('input', { type: 'checkbox', onChange: this.handleChange, checked: todo.finished }),
    ...
    item: _propTypes2.default.shape({
        ...
        finished: _propTypes2.default.bool.isRequired
    }).isRequired
}, _temp2)) || _class5;

var TodoList = (0, _mobxReact.observer)(_class7 = (_temp4 = _class8 = function (_Component2) {
    ...
    function TodoList() {
        ...
        return _ret2 = (_temp3 = (_this2 = _possibleConstructorReturn(this, (_ref2 = TodoList.__proto__ || Object.getPrototypeOf(TodoList)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = { inputValue: '' }, _this2.handleSubmit = function (e) {
            e.preventDefault();
        ...
        }, _this2.handleClick = function (todo, e) {
            _this2.props.store.removeItem(todo);
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            ...
            // 有助于调试
            // trace(true)
            var list = this.props.store.list;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'ul',
                        null,
                        store.list.map(function (item, index) {
                            return _react2.default.createElement(
                                'li',
                                { key: index },
    ...
    store: _propTypes2.default.shape({
        list: _mobxReact.PropTypes.observableArrayOf(_mobxReact.PropTypes.observableObject).isRequired
    }).isRequired
}, _temp4)) || _class7;

_reactDom2.default.render(_react2.default.createElement(TodoList, { store: store }), document.querySelector('#app'));
